...
- **Known unfixed unbounded-click races:** `QuotationsPage.fillOwner()`, parts of `LeadsPage.ts` (close-reason radio, convert-to-deal product selection), several `QuotationsPage.ts` random-option pickers.
