...
For all other reference material (architecture, tech stack, commands, CI/CD, module status, audit findings), see the `.claude/` documentation directory.
...
- **[`.claude/codebase-reference.md`](./.claude/codebase-reference.md)** — Architecture, tech stack, commands, CI/CD, module status, audit findings
- **[`.claude/known-issues.md`](./.claude/known-issues.md)** — Bug investigations, root causes, unresolved issues, session-expiry gaps
- **[`.claude/reference-patterns.md`](./.claude/reference-patterns.md)** — 10 canonical code patterns with working examples
