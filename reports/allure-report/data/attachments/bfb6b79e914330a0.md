...
Call log:
  - waiting for locator('.rt-tr-group .clip-text').filter({ hasText: /^Tommie$/ }).first() to be visible
...
- generic [ref=e1]:
      ...
      - main [ref=e157]:
        - generic [ref=e158]:
            ...
            - generic [ref=e165]:
              - generic [ref=e166]:
                - button [ref=e167] [cursor=pointer]:
                  - img [ref=e168]
                - generic [ref=e172]:
                  - searchbox "Search" [active] [ref=e173]: Tommie
          ...
          - generic [ref=e212]:
            ...
            - generic:
              - generic: Loading...
    - img "Chat Bot" [ref=e406] [cursor=pointer]
  - generic [ref=e407]:
    - generic [ref=e408]:
      - generic [ref=e409]:
        ...
        - button [ref=e413] [cursor=pointer]:
          - img [ref=e414]
      - paragraph [ref=e416]: Secured by viaSocket
    - iframe [ref=e417]:
      - generic [ref=f45e4]:
        - generic [ref=f45e6]:
  ...
  - iframe [ref=e419]:
    - generic [ref=f52e4]:
      - generic [ref=f52e5]:
        - heading "Announcements" [level=3] [ref=f52e7]
        - generic [ref=f52e8]:
          - link "Features Kylas 5.7 Release. Data Import Import Users No manuall works to add your users into the system, just simply upload ..." [ref=f52e9] [cursor=pointer]:
            - /url: "#"
            - generic [ref=f52e10]: Features
            - strong [ref=f52e11]: Kylas 5.7 Release.
            - text: Data Import Import Users No manuall works to add your users into the system, just simply upload ...
          - link "Features Kylas 5.6 Release. Rule Engine on Call entity Rule engine helps you to set conditional logic in order to freeze the..." [ref=f52e12] [cursor=pointer]:
            - /url: "#"
            - generic [ref=f52e13]: Features
            - strong [ref=f52e14]: Kylas 5.6 Release.
            - text: Rule Engine on Call entity Rule engine helps you to set conditional logic in order to freeze the...
        - link "Learn more" [ref=f52e16] [cursor=pointer]:
          - /url: https://headwayapp.co/kylas-sales-crm-updates?utm_medium=widget
      - generic [ref=f52e17]:
        - generic [ref=f52e18]:
          - generic [ref=f52e19]:
            - link [ref=f52e20] [cursor=pointer]:
              - /url: "#back"
            - heading "Kylas 5.7 Release" [level=3] [ref=f52e21]
          - generic [ref=f52e22]:
            - paragraph
        - generic [ref=f52e24]:
          - generic [ref=f52e25]:
            - link [ref=f52e26] [cursor=pointer]:
              - /url: "#back"
            - heading "Kylas 5.6 Release" [level=3] [ref=f52e27]
          - paragraph [ref=f52e30]:
            - link "Read more" [ref=f52e31] [cursor=pointer]:
...
```ts
  100 |         logger.info('Closing open modal before navigation');
  101 |         const cancelBtn = this.page.locator('button[data-dismiss="modal"]').first();
  102 |         await cancelBtn.click();
  103 |         await modal.waitFor({ state: 'hidden', timeout: 5000 });
  104 |       }
  105 |     } catch {
  106 |       // No modal open
  107 |     }
